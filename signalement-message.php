...
$sql = "INSERT INTO `signalement_message` (`signalement`, `id_utilisateur`, `id_message`) VALUES('$_POST[reportreason]','$_SESSION[id]','$_SESSION[messageid]')";
