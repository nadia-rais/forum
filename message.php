...
<body>
    ...
    <?php
      ...
      while($value=mysqli_fetch_assoc($query)){
          ...
          echo "<tr><td id='left-livre'><p>".$value['id_message'].".</p><p> Posté par :</p><a href='profil.php'>".$value['login']."</a></td>";
        ...
        if(isset($_POST['submit_msg'])){
          $request2="INSERT INTO `messages`(`message`, `id_utilisateur`, `id_conversation`) VALUES ('".$_POST['msg_conv']."','1','".$_GET['id_conversation']."')";
